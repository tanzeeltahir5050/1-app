...
function Pricing() {
    return (
        <>
            <div className='rounded-[48px] min-w-full md:w-[498px] bg-blue-500 py-8 my-12 h-[770px] relative'>
                <h1 className='font-bold text-3xl md:text-5xl text-white text-center mt-16'>Pick Your Best Plan</h1>
                <p className='font-semibold text-base md:text-lg text-center py-8 text-white'>Innovative solutions designed to streamline your workflow and boost productivity.Unlock the full potential of your business with cutting-edge technology.</p>
                <div>
                    <div className='w-[374px] h-[644px] bg-[#FFFFFF] drop-shadow-2xl absolute top-96 left-40 rounded-[20px]'>
                    ...
                    <div className='w-[374px] h-[654px] bg-[#FFFFFF] drop-shadow-2xl absolute top-[20rem] left-[30rem] z-10 rounded-[20px]'>
                    ...
                    <div className='w-[374px] h-[644px] bg-[#FFFFFF] drop-shadow-2xl absolute top-96 right-40 rounded-[20px]'>
                        <div className='flex flex-col items-center justify-center m-4 p-4'>
