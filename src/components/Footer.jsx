            ...
            <div className='min-w-full md:w-[498px] h-auto bg-[#161C28] py-8 mt-96'>
                <div className='w-full flex justify-evenly items-center flex-col md:flex-row'>
                    <div className='md:w-[466px] h-full md:h-[588px]'>
                        <h1 className='font-medium md:font-semibold text-3xl md:text-5xl text-white'>People are Saying About Us</h1>
                        ...
                        <div className='flex'>
                            {imageData.map((item) => (
                                <img key={item.id} className='rounded-full w-8 h-8 md:w-16 md:h-16 mx-1 md:mx-2' src={item.imgName} alt="" />
                            ))}
                        </div>
                    </div>
                ...
                <div className='flex flex-col md:flex-row items-center justify-between'>
                    <div className=''>
                        <h1 className='font-medium md:font-semibold text-3xl md:text-5xl pt-4 text-[#3585FF]'>TO-DO</h1>
                        <p className='font-medium text-lg text-[#A6A6A6] my-4 md:my-8'>Get started noew try our product</p>
                    ...
                    <div className='flex flex-col md:flex-row justify-evenly'>
                        <div className=''>
                            <h1 className='font-medium text-white text-lg pt-4 pb-4'>Support</h1>
                            <ul>
                                {supportLinks.map((item) => (
                                    <li key={item.id} className='pb-3'>
                                        <a href="#" className='font-normal md:font-medium text-[#A6A6A6] text-base md:text-lg'>{item.name}</a>
                                    </li>
                                ))}
                            </ul>
                        </div>
                        <div className='w-[195px] h-[200px]'>
                            <h1 className='font-medium text-white text-lg pt-4 pb-4'>Help and Solution</h1>
                            <ul>
                        ...
                        <div className='w-[195px] h-[200px]'>
                            <h1 className='font-medium text-white text-lg pt-4 pb-4'>Product</h1>
                            <ul>
                ...
                <div className='flex flex-col md:flex-row items-center justify-between pt-5 md:m-20'>
                    <p className='font-normal md:font-medium text-base md:text-sm text-white'>&copy; 2022 Inc. Copyright and rights reserved</p>
                    <p className='font-normal md:font-medium text-base md:text-sm text-white'>Terms and Condtions . Privacy Policy</p>
                </div>
            </div>
        </>
    )
